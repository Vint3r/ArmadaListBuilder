...
public class Ship {
	...
	public Ship(int id, int afRed, int afBlue, int afBlack, int command, int cost, int engineering, int hull,
			...
			List<ShipDefenseToken> defenseTokens, List<Image> images, List<ShipUpgradeType> upgradeTypes) {
		super();
		this.id = id;
		this.afRed = afRed;
		this.afBlue = afBlue;
	...
	public List<ShipUpgradeType> getUpgradeTypes() {
		return upgradeTypes;
	}

	public void setUpgradeTypes(List<ShipUpgradeType> upgradeTypes) {
		this.upgradeTypes = upgradeTypes;
	}

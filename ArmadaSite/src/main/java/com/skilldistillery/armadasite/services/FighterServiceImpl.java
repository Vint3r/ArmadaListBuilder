...
public class FighterServiceImpl implements FighterService {
	...
	public List<Fighter> getAllFightersByAlign(String align) {
		...
		return fighterRepo.findByAlignmentLikeOrderByCost(keyword);
	}
	...
	public List<Fighter> getFightersByCardKey(int keyId) {
		return fighterRepo.findByKeywordsIdOrderByCost(keyId);
	}

	@Override
	public List<Fighter> getFightersByCost(int cost) {
		return fighterRepo.findByCostLessThanEqualOrderByCost(cost);
	}
